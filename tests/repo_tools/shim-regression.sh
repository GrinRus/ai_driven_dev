...
check_shim "actions-validate.sh" "skills/aidd-core/scripts/actions-validate.sh"
check_shim "context-map-validate.sh" "skills/aidd-core/scripts/context-map-validate.sh"
...
check_shim_runtime_warning "actions-validate.sh"
check_shim_runtime_warning "context-map-validate.sh"
