...
- Выполнить runtime bootstrap probe (без внешнего `PYTHONPATH`) и сохранить `01_runtime_bootstrap_probe.txt`:
  - `python3 <plugin_runtime_path>/skills/aidd-flow-state/runtime/set_active_stage.py --help`
  - `python3 <plugin_runtime_path>/skills/status/runtime/index_sync.py --help`
  - `python3 <plugin_runtime_path>/skills/review/runtime/review_report.py --help`
  - `python3 <plugin_runtime_path>/skills/aidd-rlm/runtime/rlm_slice.py --help`
