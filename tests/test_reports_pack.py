...
class ReportsPackTests(unittest.TestCase):
    ...
    def test_call_graph_pack_created(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            edges_path = Path(tmpdir) / "CG-1-call-graph.edges.jsonl"
            edges = [
                {
                    "schema": "aidd.call_graph_edge.v1",
                    "caller": "demo.A",
                    "callee": "foo",
                    "caller_file": "src/Main.kt",
                    "caller_line": 3,
                    "callee_file": "src/Main.kt",
                    "callee_line": 3,
                    "lang": "kotlin",
                    "type": "call",
                },
            ...
            payload = {
                ...
                "slug": "cg-1",
                "generated_at": "2024-01-05T00:00:00Z",
                "call_graph_edges_stats": {"edges_scanned": 2, "edges_written": 2},
                "call_graph_edges_path": str(edges_path),
            }
            pack = reports_pack.build_call_graph_pack(
                payload,
                source_path="reports/research/CG-1-context.json",
