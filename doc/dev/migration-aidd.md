...
2. Удалите legacy-снапшоты из корня: `.claude/`, `.claude-plugin/`, `config/`, `docs/`, `repo_tools/`, `templates/`. Продуктовый код и ваши артефакты оставьте.
...
6. Запустите smoke-проверку в репозитории: `repo_tools/smoke-workflow.sh`.
