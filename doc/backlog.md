...
- [ ] Единая модель статусов PRD/планов: привести к `READY/BLOCKED/PENDING` и синхронизировать тексты/проверки в `src/claude_workflow_cli/data/payload/aidd/agents/planner.md`, `src/claude_workflow_cli/data/payload/aidd/agents/validator.md`, `src/claude_workflow_cli/data/payload/aidd/commands/plan-new.md`, `src/claude_workflow_cli/data/payload/aidd/commands/idea-new.md`, `src/claude_workflow_cli/data/payload/aidd/agents/analyst.md`, `src/claude_workflow_cli/data/payload/aidd/docs/prompt-playbook.md`.
- [ ] Убрать двусмысленные статусы `READY?BLOCKED`/`BLOCKED?READY` и заменить на явные состояния с правилами перехода (`BLOCKED`/`PENDING` с вопросами → `READY` после ответов) в `src/claude_workflow_cli/data/payload/aidd/commands/idea-new.md` и `src/claude_workflow_cli/data/payload/aidd/agents/analyst.md`.
