...
| --- | --- | --- | --- | --- |
| `analyst` / `/idea-new` | `aidd/docs/prd/<ticket>.prd.md` (включая `## AIDD:RESEARCH_HINTS`) | `gate-workflow` | PRD READY/BLOCKED, список вопросов | `aidd/docs/prd/template.md`, `dev/doc/agents-playbook.md` |
...
| `reviewer` / `/review` | Diff, план, tasklist | `gate-tests`, `gate-qa` | Замечания + tasklist | `dev/doc/agents-playbook.md` |
