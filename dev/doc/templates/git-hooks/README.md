...
```bash
cp dev/doc/templates/git-hooks/commit-msg.sample .git/hooks/commit-msg
...
- Сохраняйте хуки под контролем версий в `dev/doc/templates/git-hooks/`, а в `.git/hooks/` держите копии.
