...
3. Установите плагин через marketplace и запустите `/feature-dev-aidd:aidd-init` — появится `./aidd`.
...
5. Перегенерируйте контекст Researcher при сомнениях: `${CLAUDE_PLUGIN_ROOT}/tools/research.sh --ticket <ticket> --auto`.
