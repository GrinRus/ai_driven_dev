...
Apply patches with `dev/repo_tools/apply_json_patch.py --input <report.json> --patch <report.patch.json>`.
...
<!-- report-stats:start -->
No reports found. Run `python3 dev/repo_tools/report_stats.py --write` after reports exist.
<!-- report-stats:end -->
