...
- Приложи выдержки из `docs/research/&lt;ticket&gt;.md`: точки интеграции, что переиспользуем (как/где, риски, тесты/контракты), паттерны/антипаттерны, ссылки на команды и call/import graph, если строился.
