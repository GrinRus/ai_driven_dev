...
3) Используя @docs/prd.template.md, @docs/research/$1.md и @workflow.md, **допиши автоматически созданный черновик** `docs/prd/$1.prd.md`: зафиксируй `## Диалог analyst`, обнови статус с `draft` на `READY` только когда ответы собраны, добавь ссылку на `docs/research/$1.md`.
