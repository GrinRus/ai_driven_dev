...
- CLI generated by the bootstrap (`scripts/commit_msg.py`, `scripts/branch_new.py`, `scripts/conventions_set.py`) — build commit messages, create branches per presets, and switch commit modes on demand.
