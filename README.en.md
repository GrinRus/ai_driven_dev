...
- The feature stage is stored in `aidd/docs/.active_stage` and updated by slash commands (`/idea-new`, `/plan-new`, `/tasks-new`, `/implement`, `/review`, `/qa`); you can roll back to any step.
