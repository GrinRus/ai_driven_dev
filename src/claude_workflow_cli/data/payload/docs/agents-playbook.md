...
- **Вход:** свободное описание задачи + данные из репозитория (`doc/backlog.md`, `docs/research/<ticket>.md`, `reports/research/<ticket>-context.json`, дев-заметки).
...
- **Вход:** PRD, backlog, `reports/research/<ticket>-targets.json`, `reports/research/<ticket>-context.json`, связанные ADR/PR, тестовые каталоги.
