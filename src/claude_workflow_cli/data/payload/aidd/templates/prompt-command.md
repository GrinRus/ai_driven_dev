...
- Перечислите хуки/гейты и команды, запускаемые во время выполнения (`python3 tools/set_active_feature.py`, `claude-workflow research`, `${CLAUDE_PROJECT_DIR}/.claude/hooks/format-and-test.sh`, `./gradlew test`, `rg`).
...
- Добавьте ссылки на шаблоны (`templates/prompt-agent.md`, `aidd/docs/prompt-playbook.md`) и требования к структуре правок, включая хранение команд и источников данных.
