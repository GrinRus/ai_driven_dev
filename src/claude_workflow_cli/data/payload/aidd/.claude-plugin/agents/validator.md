...
## Входные артефакты
- `docs/prd/<ticket>.prd.md` — должен быть в статусе READY и содержать актуальный `## PRD Review`.
- `docs/plan/<ticket>.md` — свежесформированный план.
- `docs/research/<ticket>.md` — список точек интеграции/рисков для кросс-проверки.
