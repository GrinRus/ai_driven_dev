...
## Input Artifacts
- `aidd/docs/prd/<ticket>.prd.md` (section `## Research Hints`), `aidd/docs/plan/<ticket>.md` (if any), `aidd/docs/tasklist/<ticket>.md`.
- `aidd/reports/research/<ticket>-context.json` and `-targets.json`.
- slug-hint in `aidd/docs/.active_feature`, ADRs/PRs.

## Automation
- Use `claude-workflow research --ticket <ticket> --auto --deep-code --call-graph [--paths ... --keywords ...]`, driven by PRD `## Research Hints`.
...
## Step-by-step Plan
1. Read PRD/plan/tasklist and JSON context; extract `## Research Hints`.
