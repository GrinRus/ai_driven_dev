...
- Если data/research не закрывают вопрос — формулируй конкретные `Вопрос N: …`, требуй `Ответ N: …`; без ответов статус остаётся BLOCKED.
...
- Пропиши статус READY/BLOCKED, оставшиеся вопросы, напомни формат `Ответ N: …`.
