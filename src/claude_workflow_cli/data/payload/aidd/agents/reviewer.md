...
- Форматирование/тесты автоматически запускаются`${CLAUDE_PROJECT_DIR:-.}/.claude/hooks/format-and-test.sh`; проверяй его вывод и проси повторный прогон при необходимости.
