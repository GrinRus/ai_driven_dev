...
- Форматирование/тесты автоматически запускаются`${CLAUDE_PLUGIN_ROOT:-./aidd}/.claude/hooks/format-and-test.sh`; проверяй его вывод и проси повторный прогон при необходимости.
