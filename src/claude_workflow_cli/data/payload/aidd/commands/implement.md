...
2. После каждой правки наблюдай за автозапуском`${CLAUDE_PLUGIN_ROOT:-./aidd}/hooks/format-and-test.sh`; при необходимости вручную запусти`!${CLAUDE_PLUGIN_ROOT:-./aidd}/hooks/format-and-test.sh`.
