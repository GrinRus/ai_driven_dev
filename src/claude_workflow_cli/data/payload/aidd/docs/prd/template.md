...
- **Автоматизация и проверки**: `<Команды/хуки, которые должен запускать агент>` (например, `<test-runner> <args>`, `claude-workflow progress --source implement --ticket ABC-123`)
