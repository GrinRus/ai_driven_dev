...
CLAUDE_QA_DRY_RUN=1 "$CLAUDE_PROJECT_DIR"/.claude/hooks/gate-qa.sh --payload '{"tool_input":{"file_path":"src/main/App.kt"}}'
```
...
3. Запустите `"$CLAUDE_PROJECT_DIR"/.claude/hooks/gate-qa.sh --payload '{}'`. Скрипт вызовет
