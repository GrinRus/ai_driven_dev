...
| Mobile | Подключите платформенные форматтеры/тесты | Убедитесь, что SDK и раннер доступны в PATH |
| Data/ML | Оставьте форматирование мягким, добавьте проверку артефактов | Расширьте правила в `config/gates.json` под ваши модели |
