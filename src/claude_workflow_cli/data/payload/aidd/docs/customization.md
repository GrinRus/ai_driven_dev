...
- `tests_gate` — правила сопоставления исходников и тестов (`source_roots`, `source_extensions`, `test_patterns`, `test_extensions`). По умолчанию покрывает JVM и non‑JVM сценарии (Python/JS/TS/Go/Ruby).
