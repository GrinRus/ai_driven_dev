...
def _apply_context_quality_details(root: Path, ticket: str, details: Optional[Dict[str, Any]]) -> None:
    ...
    context_quality.update_metrics(
        ...
        memory_slice_reads=int(raw.get("memory_slice_reads") or 0),
        ...
        rg_invocations=int(raw.get("rg_invocations") or 0),
        rg_without_slice=int(raw.get("rg_without_slice") or 0),
        decisions_pack_stale_events=int(raw.get("decisions_pack_stale_events") or 0),
