...
5. Fill actions.json (v1): create `aidd/reports/actions/<ticket>/<scope_key>/implement.actions.json` from template and validate schema via `python3 ${CLAUDE_PLUGIN_ROOT}/skills/implement/runtime/implement_run.py` before postflight.
