...
6. Orchestration: use the existing rolling context pack (do not regenerate it), Fill actions.json (v1) at `aidd/reports/actions/<ticket>/<scope_key>/implement.actions.json`, and validate schema via `python3 skills/implement/runtime/implement_run.py`.
...
## Command contracts
### `python3 skills/implement/runtime/implement_run.py`
