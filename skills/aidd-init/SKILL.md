...
allowed-tools:
  - Read
  - Write
  - "Bash(${CLAUDE_PLUGIN_ROOT}/skills/aidd-init/scripts/init.sh:*)"
model: inherit
...
## Steps
1. Run `${CLAUDE_PLUGIN_ROOT}/skills/aidd-init/scripts/init.sh` (add `--force` or `--detect-build-tools` if provided).
