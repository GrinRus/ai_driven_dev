    ...
    *,
    ...
    if context == "handoff":
        guidance = (
            ...
            f"в {tasklist_rel} и повторите `python3 ${{CLAUDE_PLUGIN_ROOT}}/skills/aidd-flow-state/runtime/progress_cli.py "
        ...
        guidance = (
            ...
            "обновите строку `Checkbox updated: …` и повторите `python3 ${CLAUDE_PLUGIN_ROOT}/skills/aidd-flow-state/runtime/progress_cli.py "
