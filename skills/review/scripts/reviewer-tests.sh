...
LOG_PATH="$(aidd_log_path "$AIDD_ROOT" "$AIDD_STAGE" "$AIDD_TICKET" "$AIDD_SCOPE_KEY" "reviewer-tests")"

run_tool() {
  aidd_run_python_module "review" "reviewer-tests" "skills/review/runtime/reviewer_tests.py" "${FORWARD_ARGS[@]}"
}
