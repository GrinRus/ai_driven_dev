...
LOG_PATH="$(aidd_log_path "$AIDD_ROOT" "$AIDD_STAGE" "$AIDD_TICKET" "$AIDD_SCOPE_KEY" "review-report")"

run_tool() {
  aidd_run_python_module "review" "review-report" "skills/review/runtime/review_report.py" "${FORWARD_ARGS[@]}"
}
