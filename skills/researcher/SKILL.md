...
9. Never use legacy user-facing planner alias from pre-wave commands; classify it as prompt-flow drift and keep canonical handoff `/feature-dev-aidd:plan-new <ticket>`.
