...
`profile.md` is the source of truth for architecture boundaries, invariants, and allowed dependencies.

## Who updates it
- Owner of the repository architecture (or designated team).
