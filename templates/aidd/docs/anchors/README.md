...
Stage anchors — короткие правила работы на стадии (цели, что читать, что обновлять).
Их задача — уменьшить токены и “плавание процесса”.

## Stages
- idea: aidd/docs/anchors/idea.md
- research: aidd/docs/anchors/research.md
