...
- `PYTHONPATH=${CLAUDE_PLUGIN_ROOT:-.} python3 -m aidd_runtime.cli set-active-stage tasklist` фиксирует стадию `tasklist`.
...
## Пошаговый план
1. Зафиксируй стадию `tasklist`: `PYTHONPATH=${CLAUDE_PLUGIN_ROOT:-.} python3 -m aidd_runtime.cli set-active-stage tasklist`.
2. Зафиксируй активную фичу: `PYTHONPATH=${CLAUDE_PLUGIN_ROOT:-.} python3 -m aidd_runtime.cli set-active-feature --target . "$1"`.
