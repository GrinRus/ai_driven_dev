...
- Команда должна запускать саб-агента `@agent-feature-dev-aidd:researcher` (Claude: Run agent → @agent-feature-dev-aidd:researcher).
...
4. Запусти саб-агента `@agent-feature-dev-aidd:researcher` и обнови `aidd/docs/research/<ticket>.md`.
