    ...
    *,
    ...
    if not doc_path.exists():
        ...
        raise ResearchValidationError(
            ...
            f"`PYTHONPATH=${{CLAUDE_PLUGIN_ROOT:-.}} python3 -m aidd_runtime.cli research --ticket {ticket} --auto` "
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if not (root / "docs").exists():
        ...
        parser.exit(
            ...
            f"Run '/aidd-init' or 'PYTHONPATH={plugin_root} python3 -m aidd_runtime.cli init --target <workspace>'.",
        )
