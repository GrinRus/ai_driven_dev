...
- [ ] Метрики успеха и ограничения подтверждены репозиторием (`doc/backlog.md`, `reports/research/&lt;ticket&gt;-context.json`).
...
- [ ] Обновлён roadmap/бэклог (`doc/backlog.md`, `docs/roadmap.md`).
