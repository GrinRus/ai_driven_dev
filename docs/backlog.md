...
_Статус: plan. Цель — staged rollout dual-classification через feature-flag без изменения default verdict до стабилизации._
...
_Статус: plan. Цель — пере-дизайн seed convergence без invasive runtime lock и без изменения default verdict._
